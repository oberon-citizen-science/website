...
::: {.aside}
Please consider supporting Oberon Citizen Science Network by [applying for membership](register_interest.html), or making a financial donation to help fund our projects and programme of work, via the button below. 

<form action="https://www.paypal.com/donate" method="post" target="_top">
<input type="hidden" name="hosted_button_id" value="XJ8LFZSR28M2L" />
...
Please note that although we are a non-profit association, donations are not currently tax-deductible (we will be seeking tax-deductible gift recipient status in the near future).
...
To mark National Science Week 2026, Oberon Citizen Science Network is proud to present a  free community event, **"Science in Oberon: More than you imagine"**, at the [Malachi Gilmore Hall](https://malachigilmorehall.com.au) in Oberon on **Saturday, 15th August 2026.**

Full details are available [here](national-science-week-2026-oberon.html).

Bookings for free tickets are available [here](https://events.humanitix.com/science-in-oberon-more-than-you-imagine). 

::: {#fig-natsciweek layout-ncol=2}
...
This is the website for the recently formed Oberon Citizen Science Network (OCSN, pronounced **"oxen"**). Please read on for more information!
...
![Oberon Citizen Science Network (OCSN) is proud to be a [Landcare Australia](https://landcareaustralia.org.au) affiliated group.](assets/Oberon Citizen Science Network Logo Pack/SVG/Oberon Citizen Science Network_Colour Stacked Positive.svg){width=65%}
...
::: {.callout-note title="Strictly non-political and non-aligned" appearance="simple"}
...
::::: {.callout-important title="Acknowledgement of Country" appearance="simple"}

:::: {layout="[ 25, 75 ]"}

::: {#first-column}
![](assets/first_nations_flags.png)
:::
...
Please read on using the link below or the links at the left to learn more about OCSN and its aims and potential activities.
