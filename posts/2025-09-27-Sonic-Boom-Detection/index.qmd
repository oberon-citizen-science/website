...
It is also noticeable that there is a general trend towards weakening signal strength as the day progressed. The final two detections were so weak, that it was necessary to reduce the bandpass filter width to excluse other infrasound noise to detect the signal. It is likely that this is the result of developing atmospheric conditions on the day: increasing thermals and updrafts over the land causing increasing sea breeze and pressure and temperature gradients developing to bend the signal away from the ground.
