...
if (!file.exists(paste0(wip_prefix, "vshed_number_visible.tif"))) {
  ...
  writeRaster(vshed_number_visible, paste0(wip_prefix, "vshed_number_visible.tif"))
} 

rm(localtif)

vshed_number_visible <- terra::rast(paste0(wip_prefix, "vshed_number_visible.tif")) 
