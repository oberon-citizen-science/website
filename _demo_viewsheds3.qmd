...
# Read heywhats that viewshed
hwt_viewshed <- sf::st_read("~/Downloads/wt/")
sf::st_layers("~/Downloads/wt/j0iBYdv7T_.kml")
hwt_viewshed <- sf::st_read("~/Downloads/Top of Shooters Hill Fire TowerTower.kml")
```

## Interactive viewshed map for Shooters Hill Fire Tower

Based on 90m x 90m aggregated elevation map, with observer height at 1.8m.
