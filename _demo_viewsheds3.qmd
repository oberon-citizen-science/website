...
vshed_terra_rast <- terra::rast("_wip/terra_vshed3.tif")
...
##plot.new()
#terra::plot(vshed_terra_rast, add=TRUE, col = "red", axes=FALSE, box=FALSE, legend = FALSE, alpha=0.4)
