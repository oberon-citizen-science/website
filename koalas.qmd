...
Historical evidence of how plentiful koalas once were around Oberon is provided by this excerpt from an interview with Mick O'Connell on page 44 of the book _Living Treasures of Oberon_ by Mick Joffe (cover and title page also shown below, click or tap on the images for a larger version). Many thanks to OCSN member Maree Arrow for providing this wonderful historical note.
