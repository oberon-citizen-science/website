...
This is a copy of the application OCSN intends to submit to the August 2024 round of the [Pines Wind Farm project community sponsorship program](https://www.thepineswindfarm.com.au/sponsorship). Comments are welcome via email or the OCSN group on Facebook. Please note that the application is due to be submitted by 5pm 30 August 2024. 

::: {.aside}
![](../../assets/timelapse_oxen.png)
:::

The application guidelines can be found [here](https://cdn.prod.website-files.com/662841b87151f2ad85731c32/66a895fa1eea65f532cf7baa_20240718_ThePines_Community_Sponsorship_Guidelines_and_application.pdf?utm_source=thepineswindfarm.com.au&utm_medium=referral). OCSN and this application meet all the criteria.
...
:
: * AudioMoth device with SD cards and waterproof case: 3 devices at AU$300 each = AU$900
: * Titley Scientific AnaBat software license: AU$550
: * Brinno TLC2020 time lapse camera with waterproof case and storage card: 2 devices at AU$850 each = AU$1700
