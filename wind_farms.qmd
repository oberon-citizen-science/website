...
# protected_riparian <- sf::st_read("_wip/VulnerableLandsProtectedRiparian")

# oberon_boundary_buffered_gda94 <- st_transform(oberon_boundary_buffered,
#                                                  crs=st_crs(protected_riparian))
