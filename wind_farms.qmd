...
Some additional work-in-progress on calculating viewsheds and visual impact assessment metrics is available [here](visual_impact_assessment_capability_development_1.html) and [here](visual_impact_assessment_capability_development_2.html).
:::
