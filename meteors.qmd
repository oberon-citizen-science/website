...
A prototype all-sky camera has been built and commissioned in Chatham valley by OCSN members. It is still being tested and configured, but you can access the images it captures [here](https://all-sky.oberon-citizen.science/indi-allsky/). At this stage, we cannot guarantee that the all-sky camera will be operational all of the time, but that is the eventual aim. 
:::
